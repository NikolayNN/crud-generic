...
public abstract class AbsMappingConfigUpdateDtoPresetEntity<DTO extends AbsUpdateDto<?>, ENTITY extends AbstractEntity<?>> extends AbsMappingConfigAbstractDtoPresetEntity<DTO, ENTITY> {
